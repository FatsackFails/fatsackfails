...
excerpt: "Description: basic framework of toggle system to switch between two
  states with the same command or event. On/Off, Red Mode/Blue Mode, etc.\r

  KC Version: v1.3.4\r

  Usage: !toggle to switch back and forth between two states\r
